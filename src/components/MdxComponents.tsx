...
export const mdxComponents = {
  h1: ({ children }: { children: React.ReactNode }) => (
    <h1 className="font-[family-name:var(--font-display)] text-4xl mt-8 mb-4">{children}</h1>
  ),
  h2: ({ children }: { children: React.ReactNode }) => (
    <h2 className="font-[family-name:var(--font-display)] text-3xl mt-8 mb-4">{children}</h2>
  ),
  h3: ({ children }: { children: React.ReactNode }) => (
    <h3 className="font-[family-name:var(--font-display)] text-2xl mt-6 mb-3">{children}</h3>
  ),
