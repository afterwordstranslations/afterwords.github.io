...
const services = [
  ...
  { label: "Technical Readiness", description: "Deep briefing on your specific industry terminology to ensure accurate communication of complex concepts.", direction: "left" as const },
  { label: "Event Integration", description: "Elite linguistic talent that integrates flawlessly with your event's technical setup and production requirements.", direction: "right" as const },
];
    ...
    <div className="w-full bg-base-100 text-base-content">
      <PageHero badge="Athens-based agency specializing in live event interpretation" title="High-Impact Interpreting: The Voice of Your Global Event" subtitle='In live events, there are no "second takes." We provide ready-for-stage interpreters for international summits and high-stakes board meetings.' cta={
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link href="/portfolio" onClick={() => trackCTA("View Portfolio", "/interpreting")} className="inline-flex items-center gap-2 border border-white/20 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/10 transition-all duration-300">View Portfolio</Link>
        </div>
      } features={[
        { title: "Simultaneous & Consecutive", description: "Expert interpretation ensuring your speaker's charisma and nuances aren't lost in translation." },
        { title: "Bidirectional Mastery", description: "Greek and English fluency guaranteeing every attendee—local or foreign—remains fully engaged." },
        { title: "Stage-Ready Professionals", description: "Elite interpreters with the poise and stamina for complex topics and spontaneous Q&A sessions." },
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-8">
          <div className="lg:w-2/3">
            <SectionHeader eyebrow="Expertise Across Registers" title="From Boardrooms to" titleItalic="Summits" />
            <FadeIn delay={0.2}><p className="text-lg md:text-xl leading-relaxed text-base-content/70 mt-8">Precision requires more than fluency; it requires deep subject matter expertise. Our team thrives in corporate, legal, and diplomatic environments, adapting seamlessly to your specific professional register.</p></FadeIn>
            <FadeIn delay={0.3}><p className="text-lg md:text-xl leading-relaxed text-base-content/70 mt-4">We eliminate the risks of &ldquo;Bad Interpretation&rdquo;&mdash;such as brand damage or miscommunication&mdash;through meticulous preparation. We bring the poise and stamina needed to handle complex technical topics and spontaneous Q&amp;A sessions with absolute composure.</p></FadeIn>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28" id="why">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow="Why choose us" title="Reliability and Flexibility" description="Your trusted talent partner for elite linguistic services that integrate flawlessly with your event's technical setup." />
      ...
      <section className="py-20 md:py-28 bg-slate-900 text-white">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow="Our expertise" title="Deep Specialization" description="Whether it's a private executive session or a large-scale conference, we deliver human-led, professional verbal communication across language barriers." light />
          <FadeIn delay={0.2}>
