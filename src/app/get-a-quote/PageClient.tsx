          ...
          <FadeIn delay={0.4}>
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-white/60 max-w-xl mx-auto">
                No forms, no steps — just pick your preferred way to get in
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {/* Email */}
              <div className="order-2 md:order-1 group p-6 rounded-2xl bg-base-100 border-2 border-base-300 hover:border-warm text-left transition-all duration-300 hover:shadow-lg">
                <div className="w-12 h-12 rounded-xl bg-warm/10 flex items-center justify-center mb-4 group-hover:bg-warm/20 transition-colors">
                  <svg
                    className="w-6 h-6 text-warm"
                    fill="none"
                ...
                <p className="text-xs text-base-content/50 mb-4">
                  Write to us at your own pace — we typically reply within a few
                  hours.
                </p>
