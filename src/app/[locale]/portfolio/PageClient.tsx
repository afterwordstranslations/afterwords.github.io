...
export default function PortfolioClient() {
  ...
  const portfolioItems = [
    {
      ...
      stats: [
        { value: 300, suffix: "/yr", label: t("medicalStatPatents") },
        { value: 200, suffix: "/yr", label: t("medicalStatApplications") },
        { value: 1000, suffix: "+", label: t("medicalStatDocuments") },
      ],
    ...
    },
    {
      ...
      stats: [
        { value: 300, suffix: "+", label: t("legalStatContracts") },
        { value: 200, suffix: "+", label: t("legalStatReports") },
        { value: 50, suffix: "+", label: t("legalStatClients") },
      ],
    ...
    },
    {
      ...
      stats: [
        { value: 5, suffix: "+", label: t("booksStatBooks") },
        { value: 2000, suffix: "+", label: t("booksStatPages") },
        { value: 3, suffix: "", label: t("booksStatPublishers") },
      ],
    ...
    },
    {
      ...
      stats: [
        { value: 1, suffix: "", label: t("mediaStatSeries") },
        { value: 4, suffix: " yrs", label: t("mediaStatFestivals") },
        { value: 50, suffix: "+", label: t("mediaStatEvents") },
      ],
  ...
  const expertiseAreas = [
    ...
    },
    {
      ...
      description: t("transcreationDesc"),
      color: "text-amber-600",
    },
    {
      icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>,
      title: t("culturalConsultingTitle"),
      description: t("culturalConsultingDesc"),
  ...
  return (
    <div className="w-full bg-base-100 text-base-content">
      <PageHero badge={t("heroBadge")} title={t("heroTitle")} subtitle={t("heroSubtitle")} variant="compact" cta={
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link href="/" className="inline-flex items-center gap-2 border border-white/20 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/10 transition-all duration-300">{t("backToHome")}</Link>
        </div>
      } features={[
        { title: t("featureSMETitle"), description: t("featureSMEDesc") },
        { title: t("featureTEPTitle"), description: t("featureTEPDesc") },
        { title: t("featureTrackTitle"), description: t("featureTrackDesc") },
      ]} backgroundElement={
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={t("workEyebrow")} title={t("workTitle")} titleItalic={t("workTitleItalic")} description={t("workDescription")} />
          <FadeIn delay={0.2}>
            <p className="text-lg text-base-content/70 leading-relaxed mt-4 max-w-3xl">{t("workP2")}</p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={t("expertiseEyebrow")} title={t("expertiseTitle")} titleItalic={t("expertiseTitleItalic")} />
