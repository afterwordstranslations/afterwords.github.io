...
export default function CertifiedTranslationsClient() {
  const t = useTranslations("CertifiedTranslations");
  ...
  return (
    <div className="w-full bg-base-100 text-base-content">
      ...
      <PageHero
        ...
        features={[
          { title: t("featureAcademicTitle"), description: t("featureAcademicDesc") },
          { title: t("featureCertificationTitle"), description: t("featureCertificationDesc") },
          { title: t("featureEndToEndTitle"), description: t("featureEndToEndDesc") },
        ]}
        backgroundElement={
          <>
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-8">
          <div className="max-w-3xl">
            ...
            <FadeIn delay={0.3}>
              <p className="text-lg md:text-xl leading-relaxed text-base-content/70 mt-8">{t("aboutP1")}</p>
            </FadeIn>
            <FadeIn delay={0.4}>
              <p className="text-lg md:text-xl leading-relaxed text-base-content/70 mt-4">{t("aboutP2")}</p>
            </FadeIn>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={t("processEyebrow")} title={t("processTitle")} titleItalic={t("processTitleItalic")} description={t("processDescription")} align="center" />
      ...
      <section className="py-20 md:py-28 bg-base-200/50" id="why">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={tCommon("whyChooseUs")} title={t("whyTitle")} />
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16" staggerDelay={0.1}>
            <StaggerItem>
              <div className="bg-base-100 rounded-2xl p-8 border border-base-300 h-full hover:border-warm/30 transition-colors duration-300">
                ...
                <h3 className="font-[family-name:var(--font-display)] text-xl font-semibold text-base-content mb-3">{t("deliveryTitle")}</h3>
                <p className="text-base-content/60 leading-relaxed">{t("deliveryDesc")}</p>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-base-100 rounded-2xl p-8 border border-base-300 h-full hover:border-warm/30 transition-colors duration-300">
                ...
                <h3 className="font-[family-name:var(--font-display)] text-xl font-semibold text-base-content mb-3">{t("expressTitle")}</h3>
                <p className="text-base-content/60 leading-relaxed">{t("expressDesc")}</p>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-base-100 rounded-2xl p-8 border border-base-300 h-full hover:border-warm/30 transition-colors duration-300">
                ...
                <h3 className="font-[family-name:var(--font-display)] text-xl font-semibold text-base-content mb-3">{t("acceptanceTitle")}</h3>
                <p className="text-base-content/60 leading-relaxed">{t("acceptanceDesc")}</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
        </div>
      ...
      <section className="py-16 border-y border-base-300">
        <div className="container mx-auto px-8">
          <FadeIn><p className="text-sm font-semibold uppercase tracking-[0.2em] text-warm-dark text-center mb-4">{t("credentialsEyebrow")}</p></FadeIn>
          <FadeIn delay={0.05}><h2 className="font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight text-center text-base-content mb-5">{t("credentialsTitle")}</h2></FadeIn>
          <FadeIn delay={0.1}><p className="text-center text-base-content/70 text-lg max-w-2xl mx-auto mb-12">{t("credentialsDesc")}</p></FadeIn>
