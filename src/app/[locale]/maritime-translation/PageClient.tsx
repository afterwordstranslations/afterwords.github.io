...
export default function MaritimeTranslationClient() {
  ...
  const services = [
    { id: 1, label: t("service1Label"), description: t("service1Desc") },
    { id: 2, label: t("service2Label"), description: t("service2Desc") },
    { id: 3, label: t("service3Label"), description: t("service3Desc") },
  ];
  ...
  const languages = [
    { code: "EN/GR", label: t("langENGR"), detail: t("langENGRDetail") },
    { code: "DE", label: t("langDE"), detail: t("langDEDetail") },
    { code: "IT", label: t("langIT"), detail: t("langITDetail") },
    { code: "FR", label: t("langFR"), detail: t("langFRDetail") },
    { code: "ES", label: t("langES"), detail: t("langESDetail") },
  ];

  return (
    <div className="w-full bg-base-100 text-base-content">
      <PageHero badge={t("heroBadge")} title={t("heroTitle")} subtitle={t("heroSubtitle")} variant="full" backgroundElement={<WaveBackground />} cta={
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link href="/portfolio" onClick={() => trackCTA("View Portfolio", "/maritime-translation")} className="inline-flex items-center gap-2 font-semibold px-8 py-4 rounded-xl border border-amber-500/40 text-amber-300 hover:bg-amber-500/10 transition-all duration-300">{tCommon("viewPortfolio")}</Link>
        </div>
      } features={[
        { title: t("featureSMETitle"), description: t("featureSMEDesc") },
        { title: t("featureTEPTitle"), description: t("featureTEPDesc") },
        { title: t("featureSPOCTitle"), description: t("featureSPOCDesc") },
      ]} />
        ...
        <div className="container mx-auto px-8">
          <div className="lg:grid lg:grid-cols-3 gap-16 items-start">
            <div className="lg:col-span-2">
              ...
              <FadeIn delay={0.2}><p className="text-lg md:text-xl leading-relaxed text-base-content/70 mt-8 mb-4">{t("aboutP1")}</p></FadeIn>
              <FadeIn delay={0.3}><p className="text-lg md:text-xl leading-relaxed text-base-content/70">{t("aboutP2")}</p></FadeIn>
            </div>
            <FadeIn direction="right" delay={0.3} className="hidden lg:block mt-8">
              <div className="relative rounded-2xl border border-amber-500/20 bg-gradient-to-br from-slate-50 to-amber-50/50 p-8 shadow-sm">
                ...
                <p className="text-center text-sm text-base-content/60 leading-relaxed">{t("aboutSidebar")}</p>
              </div>
            </FadeIn>
          </div>
        </div>
      ...
      <section id="services" className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={t("servicesEyebrow")} title={t("servicesTitle")} titleItalic={t("servicesTitleItalic")} description={t("servicesDescription")} />
      ...
      <section id="why" className="py-20 md:py-28 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0a1628 0%, #0f2240 50%, #0a1e3a 100%)" }}>
        ...
        <div className="container mx-auto px-8 relative z-10">
          <SectionHeader eyebrow={tCommon("whyChooseUs")} title={t("whyTitle")} titleItalic={t("whyTitleItalic")} description={t("whyDescription")} light />
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-8">
          <SectionHeader eyebrow={tCommon("ourExpertise")} title={t("langTitle")} titleItalic={t("langTitleItalic")} description={t("langDescription")} />
